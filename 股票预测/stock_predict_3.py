...
def get_train_data(batch_size=60, time_step=20, train_begin=0, train_end=5800):
    ...
    for i in range(len(normalized_train_data) - time_step):
        ...
        y = normalized_train_data[i + time_step, 7]
...
def get_test_data(time_step=20, test_begin=5800):
    ...
    for i in range(size - 1):
        ...
        y = normalized_test_data[(i + 1) * time_step, 7]
...
def train_lstm(batch_size=60, time_step=20, train_begin=2000, train_end=5800):
    ...
    with tf.Session() as sess:
        ...
        for i in range(10):
            ...
            if i % 2 == 0:
                print("model_save: ", saver.save(sess, 'model_3/stock_predict.ckpt'))
